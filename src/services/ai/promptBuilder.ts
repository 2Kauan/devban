...
INSTRUÇÕES DE HIERARQUIA E SUB-TAREFAS (CARDS FILHOS) E CHECKLIST:
- Use a propriedade "checklist" (array de strings) para pequenas tarefas ou ações simples/rápidas que não precisam se tornar cartões independentes no quadro (ex: ["Ligar para cliente", "Enviar contrato"]).
      ...
      "tasks": [
        {
          ...
          "checklist": ["Item de checklist simples 1", "Item de checklist simples 2"],
          "subtasks": [
            {
