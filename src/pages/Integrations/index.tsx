  ...
  if (!isUnlocked) {
    return (
      <div className="flex h-screen bg-background overflow-hidden">
        <Sidebar isOpen={isSidebarOpen} onClose={() => setIsSidebarOpen(false)} onProjectCreated={() => {}} />
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-y-auto custom-scrollbar">
          ...
          <main className="flex-1 flex items-center justify-center p-4">
            <motion.div 
              ...
              className="w-full max-w-md bg-card border border-border shadow-2xl rounded-3xl p-6 sm:p-8 space-y-6 text-center backdrop-blur-md relative overflow-hidden"
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  A Central de Integrações é uma funcionalidade em pré-lançamento. Insira a senha de desenvolvedor para visualizar a página.
                </p>
              </div>
              ...
              <form onSubmit={handleUnlock} className="space-y-4 pt-2">
                <div className="relative">
                  <input
                    ...
                    className={`w-full bg-background border rounded-2xl p-3.5 pl-4 pr-12 text-sm font-mono focus:outline-none transition-all ${
                      passError 
                  ...
                  <button
                    type="submit"
                    className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-primary text-primary-foreground rounded-xl text-xs font-bold hover:bg-primary/90 transition-all cursor-pointer"
                  >
                    <ArrowRight size={16} />
                  </button>
                </div>
                ...
                {passError && (
                  <p className="text-xs font-semibold text-red-500 flex items-center justify-center gap-1">
